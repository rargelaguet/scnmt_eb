---
title: "EB scNMT-seq: pseudobulked profiles of DNA methylation and chromatin accessibility in blood enhancers"
output: 
...
source("/Users/ricard/scnmt_eb/metacc/profiles_blood_enhancers/load_settings.R")
```
...
for (i in unique(data$lineage10x_2)) {
  ...
  pdf(file=sprintf("%s/%s.pdf",io$outdir,i), width=7, height=4)
  print(p)
  dev.off()
}
```
