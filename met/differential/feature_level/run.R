...
if (grepl("ricard",Sys.info()['nodename'])) {
  io$script <- "/Users/ricard/NMT-seq_EB+ESC/met/differential/feature_level/diffmet.R"
  io$outdir <- "/Users/ricard/data/NMT-seq_EB+ESC/met/differential/feature_level"
} else {
  io$script <- "/homes/ricard/NMT-seq_EB+ESC/met/differential/feature_level/diffmet.R"
  io$outdir <- "/hps/nobackup/stegle/users/ricard/NMT-seq_EB+ESC/met/differential/feature_level"
  io$tmpdir <- "/hps/nobackup/stegle/users/ricard/NMT-seq_EB+ESC/met/differential/feature_level/tmp"
}
