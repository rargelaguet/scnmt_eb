...
## I/O ##
io <- list()
io$input.dir <- "/Users/ricard/data/NMT-seq_EB+ESC/met/differential/feature_level"
io$outdir <- "/Users/ricard/data/NMT-seq_EB+ESC/met/differential/feature_level/pdf"

## Options ##
opts <- list()
opts$comparisons <- c(
  # "Endoderm_vs_MesodermEpiblast",
  # "Mesoderm_vs_EndodermEpiblast"
  "Mesoderm_vs_Epiblast",
  "Endoderm_vs_Epiblast"
)
